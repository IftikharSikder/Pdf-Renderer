...
import 'package:flutter_boilerplate/features/account/presentation/screens/account_screen.dart';
...
class RouteConfig {
  ...
  static final goRouter = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        name: demoScreen,
        path: demoScreen.pathUrl,
        builder: ((context, state) => DemoScreen(luckyNumber: int.tryParse(state.uri.queryParameters['luckyNumber'] ?? '') ?? 0)),
      ),
